    ...
    module Dataforms
      ...
      class XData < X
        ...
        def add_field_with_value(var, value)
          field = Dataforms::XDataField.new(var)
          field.values = value
          self << field
        end
      ...
      class XDataReported < XMPPElement
        ...
        def fields(including_hidden=false)
          fields = []
          each_element do |xe|
            if xe.kind_of?(Dataforms::XDataField) and (including_hidden or (xe.type != :hidden and xe.type != :fixed))
              fields << xe
            end
          end
          fields
        ...
        #.....................................................................................................
        def add_field(var)
          self << Dataforms::XDataField.new(var)
        end
      end
