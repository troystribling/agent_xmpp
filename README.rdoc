...
Agent XMPP is an application framework for writing XMPP clients that support Messaging, Ad-Hoc Commands and Publish Subscribe 
...
XMPP provides a simple form specification for entry of <em>Ad-Hoc Command</em> parameters, http://xmpp.org/extensions/xep-0004.html#protocol-fieldtypes. Agent XMPP supports the following form controls.
